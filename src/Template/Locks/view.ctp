...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Lock'), ['action' => 'edit', $lock->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Lock'), ['action' => 'delete', $lock->id], ['confirm' => __('Are you sure you want to delete # {0}?', $lock->id)]) ?> </li>
...
<div class="locks view large-9 medium-8 columns content">
    <h3><?= h($lock->id) ?></h3>
    ...
    <div class="related">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($lock->users as $users): ?>
            <tr>
                <td><?= h($users->id) ?></td>
